...
for j in latticesizes:
	...
	globalSystemAverage['{}x{} Average Magnetic Moment'.format(j,j)] = systemAverages.mean(axis=1)
	globalSystemAverage['{}x{} Average Susc'.format(j,j)] = systemSusc.mean(axis=1)
	globalSystemAverage['{}x{} Average U2'.format(j,j)] = systemBinder.mean(axis=1)
