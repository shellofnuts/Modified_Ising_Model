...
init_warmupSteps = 2000 # How many times to alter the random, initialised lattice 
simulating_Steps = 1000 # How many times to alter the lattice at each Temperature
sampling_Frequency = 1 # Save the lattice after ever n alters

starting_Temp = 1.6 # Temperatire to start the simulation at
stopping_Temp = 0.8 # Temperatire to finish
interval_Temp = 0.005 # Temperature step
...
def Metropolis(test_Lattice, test_Steps, sample_Freq, sample_Temp):
	...
	test_Lattice = warmup(test_Lattice, 400, sample_Temp)
